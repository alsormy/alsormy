...
<img src="https://github.com/SP-XD/SP-XD/blob/main/images/hellocoders_rounded.gif?raw=true" href="https://github.com/alsormy" alt="Hello Coders" width="60%"/> <br>
<img src="https://github.com/SP-XD/SP-XD/blob/main/images/dev-working_rounded.gif?raw=true" href="https://github.com/alsromy" alt="Workspace"  width="40%"/><br> 
...
class About extends Me { 
  const myTools = {  
    "OtherLanguages" : { "HTML", "CSS",  "Json", "Javascript" },
    "Database" : { "SqlServer", "Sqlite", "PostgreSql" },
    "Editors" : { "Vscode", "Xcode", "Sublime", "Visual Studio" },
