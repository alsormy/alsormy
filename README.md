...
public class MohammedAlSarmi
{
    ...
    public string CurrentProject => "Sarmi ERP";
}
```
...
> Building scalable ERP systems that help businesses automate operations, improve efficiency, and make better decisions through technology.
